...
class GeminiCommenter:
    ...
    def create_prompt(self, tone: str) -> str:
        ...
        6. The user may also send an image that is a post and not a conversation, in that case generate a comment for the post
...
def main():
    ...
    with col1:
        ...
        if uploaded_file:
            ...
            st.image(image, caption="Conversation Screenshot", use_column_width=True)
